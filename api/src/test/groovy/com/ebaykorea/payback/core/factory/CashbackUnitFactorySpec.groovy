...
class CashbackUnitFactorySpec extends Specification {
  ...
  def "CashbackUnit이 정상적으로 생성되는지 확인한다"() {
    ...
    "판매자캐시백,아이템캐시백1,아이템캐시백2" | [SellerCashback_생성(), ItemCashback_생성(amount: 2000L, isSmilePay: true, cashbackPolicy: [ItemCashbackPolicy_생성(), ItemCashbackPolicy_생성(policyNo: 2L)])] | _ | _
    _________________________________________________
    결제 | 상품 | 복수할인금액 | 회원
    ...
    [RewardCashbackPolicy_생성(), RewardCashbackPolicy_생성(cashbackSeq: 2L)] | _ | _ | _
    _________________________________________________
    백엔드정책 | 리워드정책 | _ | _
    ...
    [RewardBackendCashbackPolicy_생성(), RewardBackendCashbackPolicy_생성(cashbackSeq: 2L)] | RewardCashbackPolicies_생성(cashbackPolicies: 캐시백정책, backendCashbackPolicies: 백엔드정책) | _ | _
  }
