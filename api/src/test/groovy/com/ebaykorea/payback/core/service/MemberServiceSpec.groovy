...
import static com.ebaykorea.payback.grocery.OrderGrocery.OrderBuyer_생성
...
class MemberServiceSpec extends Specification {
  ...
  def "Member가 정상적으로 생성되는지 확인"() {
    ...
    "기본"      | null      | null      | OrderBuyer_생성(member: true) | 회원_생성()
    "클럽"      | club_생성() | ""        | OrderBuyer_생성(member: true) | 회원_생성(false, 클럽결과)
    "userKey" | null      | "userKey" | OrderBuyer_생성(member: true) | Member_생성(userKey: "userKey", member: true)
  }
}
