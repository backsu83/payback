...
class SmileCashEventRequestEntityMapperSpec extends Specification {
  ...
  def "SmileCashEvent -> SmileCashEventRequestEntity 매핑 테스트"() {
    ...
    "렌터카 일반 상품평" | ReviewReward_생성(saveAmount: 100L, referenceType: ReviewReferenceType.RentalCar) | SmileCashEventRequestEntity_생성(requestMoney: 100L, requestOutputDisabledMoney: 100L, cashBalanceType: "GN", custNo: "memberKey", expireDate: Timestamp.from(request.getExpirationDate()), refNo: 1L, eid: 101L, regId: "memberKey")
    "코어 프리미엄 상품평" | ReviewReward_생성(saveAmount: 100L, eventType: EventType.ReviewPremium) | SmileCashEventRequestEntity_생성(requestMoney: 100L, requestOutputDisabledMoney: 100L, cashBalanceType: "GP", custNo: "memberKey", expireDate: Timestamp.from(request.getExpirationDate()), refNo: 1L, eid: 100L, regId: "memberKey")
  }
