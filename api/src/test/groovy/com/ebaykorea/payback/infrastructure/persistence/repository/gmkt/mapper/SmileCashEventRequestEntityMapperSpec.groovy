...
class SmileCashEventRequestEntityMapperSpec extends Specification {
  ...
  def "SmileCashEvent -> SmileCashEventRequestEntity 매핑 테스트"() {
    ...
    "이벤트" | EventReward_생성(saveAmount: 100L, eventNo: 1L) | SmileCashEventRequestEntity_생성(requestMoney: 100L, requestOutputDisabledMoney: 100L, cashBalanceType: "G8", custNo: "memberKey", expireDate: Timestamp.from(request.getExpirationDate()), refNo: 1L, eid: 1L, regId: "memberKey")
    "이벤트 - expirationDate 있을때 해당 만료일자" | EventReward_생성(saveAmount: 100L, expirationDate: Instant.parse("2023-12-04T09:35:24.00Z"), eventNo: 1L) | SmileCashEventRequestEntity_생성(requestMoney: 100L, requestOutputDisabledMoney: 100L, cashBalanceType: "G8", custNo: "memberKey", expireDate: Timestamp.from(Instant.parse("2023-12-04T09:35:24.00Z")), refNo: 1L, eid: 1L, regId: "memberKey")
    "렌터카 일반 상품평" | ReviewReward_생성(saveAmount: 100L, referenceType: ReviewReferenceType.Moana) | SmileCashEventRequestEntity_생성(requestMoney: 100L, requestOutputDisabledMoney: 100L, cashBalanceType: "GN", custNo: "memberKey", expireDate: Timestamp.from(request.getExpirationDate()), refNo: 1L, eid: 101L, regId: "memberKey", integrationType: "L")
    "코어 프리미엄 상품평" | ReviewReward_생성(saveAmount: 100L, eventType: EventType.ReviewPremium) | SmileCashEventRequestEntity_생성(requestMoney: 100L, requestOutputDisabledMoney: 100L, cashBalanceType: "GP", custNo: "memberKey", expireDate: Timestamp.from(request.getExpirationDate()), refNo: 1L, eid: 100L, regId: "memberKey", integrationType: "L")
  }
