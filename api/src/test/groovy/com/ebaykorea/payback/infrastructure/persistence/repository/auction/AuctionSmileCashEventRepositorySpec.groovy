...
class AuctionSmileCashEventRepositorySpec extends Specification {
  ...
  def "중복요청 여부에 따라 저장 호출을 올바르게 한다"() {
    ...
    "중복요청이 있을 경우" | [SmileCashSaveQueueEntity_생성(bizType: 9, reasonCode: "RM02Y")] | CashEventRewardRequest_생성(requestId: "memberKey", requestNo: 1L, eventType: EventType.Toss)
    "BizKey 조회건이 있지만 중복요청이 아닌 경우" | [SmileCashSaveQueueEntity_생성(bizType: 9, reasonCode: "RM01Y")] | CashEventRewardRequest_생성(requestId: "memberKey", requestNo: 5L, eventType: EventType.Toss)
    "BizKey 조회건이 없는 경우" | [] | CashEventRewardRequest_생성(requestId: "memberKey" ,requestNo: 5L)
    _________________________________________________
  ...
  def "AuctionSmileCashEventRepository 저장 결과가 정상인지 확인"() {
    ...
    CashEventRewardRequest_생성(requestId: "memberKey", requestNo: 1L, eventType: EventType.Toss) | CashEventRewardResult_생성(requestNo: 1L, smilePayNo: 1L, resultCode: -322) | _
    CashEventRewardRequest_생성(requestId: "memberKey", requestNo: 5L, eventType: EventType.Toss) | CashEventRewardResult_생성(requestNo: 5L, smilePayNo: 2L, resultCode: 0) | _
    CashEventRewardRequest_생성(requestId: "memberKey", requestNo: 5L) | CashEventRewardResult_생성(requestNo: 5L, smilePayNo: 2L, resultCode: 0) | _
  }
}
