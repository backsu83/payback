...
import static com.ebaykorea.payback.grocery.RewardGrocery.*
...
class RewardGatewaySpec extends Specification {
  ...
  def "RewardCashbackPolicies 결과가 정상인지 확인한다"() {
    ...
    _________________________________________________
    expectResult | _
    RewardCashbackPolicies_생성(cashbackPolicies: [RewardCashbackPolicy_생성()], backendCashbackPolicies: [RewardBackendCashbackPolicy_생성()], smileCardCashbackPolicies: [RewardT2T3SmileCardCashbackPolicy_생성()], ssgPointPolicies: [RewardSsgPointPolicy_생성()]) | _
    RewardCashbackPolicies_생성(cashbackPolicies: [RewardCashbackPolicy_생성(), RewardCashbackPolicy_생성(cashbackCd: CashbackType.SmilePay)], backendCashbackPolicies: [RewardBackendCashbackPolicy_생성(), RewardBackendCashbackPolicy_생성(cashbackCode: CashbackType.SmilePay)], smileCardCashbackPolicies: [RewardT2T3SmileCardCashbackPolicy_생성()], ssgPointPolicies: [RewardSsgPointPolicy_생성()]) | _
    RewardCashbackPolicies_생성(smileCardCashbackAmount: 1000L, newSmileCardCashbackAmount: 500L, cashbackPolicies: [RewardCashbackPolicy_생성()], backendCashbackPolicies: [RewardBackendCashbackPolicy_생성()], smileCardCashbackPolicies: [RewardT2T3SmileCardCashbackPolicy_생성()], ssgPointPolicies: [RewardSsgPointPolicy_생성()]) | _
  }
