...
class SmileCashSaveQueueEntityMapperSpec extends Specification {
  ...
  def "SmileCashEvent -> SmileCashSaveQueueEntity 매핑 테스트"() {
    ...
    "이벤트 - expirationDate 있을때 해당 만료일자" | ""                | EventReward_생성(saveAmount: 100, eventNo: 1L, expirationDate: Instant.parse("2023-12-04T09:35:24.00Z")) | SmileCashSaveQueueEntity_생성(reasonCode: "RM03Y", bizType: 9, bizKey: "1", smileCashType: 2, saveAmount: 100, expireDate: Timestamp.from(Instant.parse("2023-12-04T09:35:24.00Z")), insertOperator: "memberKey", referenceKey: "1")
