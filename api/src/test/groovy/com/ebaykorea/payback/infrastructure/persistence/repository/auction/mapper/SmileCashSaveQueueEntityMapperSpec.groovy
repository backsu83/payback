...
class SmileCashSaveQueueEntityMapperSpec extends Specification {
  ...
  def "SmileCashSaveQueueEntity 으로의 매핑 테스트"() {
    ...
    "expirationDate 있을때 해당 만료일자" | null                | EventRewardRequestDto_생성(requestNo: 1L, saveAmount: 100, eventType: EventType.DailyCheckIn, expirationDate: Instant.parse("2023-12-04T09:35:24.00Z")) | SmileCashSaveQueueEntity_생성(reasonCode: "RM01Y", bizType: 9, bizKey: "1", smileCashType: 2, saveAmount: 100, expireDate: Timestamp.from(Instant.parse("2023-12-04T09:35:24.00Z")), insertOperator: "memberKey")
  }
