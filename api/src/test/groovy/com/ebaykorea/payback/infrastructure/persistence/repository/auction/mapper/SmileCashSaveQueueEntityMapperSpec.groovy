...
class SmileCashSaveQueueEntityMapperSpec extends Specification {
  ...
  def "SmileCashEvent -> SmileCashSaveQueueEntity 매핑 테스트"() {
    ...
    "이벤트 - expirationDate 있을때 해당 만료일자" | "이벤트"                | EventReward_생성(saveAmount: 100, eventNo: 1L, expirationDate: Instant.parse("2023-12-04T09:35:24.00Z")) | SmileCashSaveQueueEntity_생성(reasonCode: "RM03Y", bizType: 9, bizKey: "1", smileCashType: 2, saveAmount: 100, expireDate: Timestamp.from(Instant.parse("2023-12-04T09:35:24.00Z")), insertOperator: "memberKey", referenceKey: "1", reasonComment: "이벤트", additionalReasonComment: "이벤트")
    "일반 상품평"                           | "일반 상품평"                | ReviewReward_생성(saveAmount: 100)                                                                       | SmileCashSaveQueueEntity_생성(reasonCode: "RM04Y", bizType: 9, bizKey: "1", smileCashType: 2, saveAmount: 100, expireDate: Timestamp.from(request.getExpirationDate()), insertOperator: "memberKey", referenceKey: "100", saveStatus: 3, reasonComment: "일반 상품평", additionalReasonComment: "일반 상품평")
    "코어 프리미엄 상품평"                      | ""                | ReviewReward_생성(saveAmount: 100, eventType: EventType.ReviewPremium)                                   | SmileCashSaveQueueEntity_생성(reasonCode: "RM05Y", bizType: 9, bizKey: "1", smileCashType: 2, saveAmount: 100, expireDate: Timestamp.from(request.getExpirationDate()), insertOperator: "memberKey", referenceKey: "100", saveStatus: 3)
  }
