...
class SmileCashSaveQueueEntityMapperSpec extends Specification {
  ...
  def "SmileCashEvent -> SmileCashSaveQueueEntity 매핑 테스트"() {
    ...
    "렌터카 일반 상품평"                 | null                | ReviewReward_생성(saveAmount: 100, referenceType: ReviewReferenceType.Moana) | SmileCashSaveQueueEntity_생성(reasonCode: "RM04Y", bizType: 9, bizKey: "1", smileCashType: 2, saveAmount: 100, expireDate: Timestamp.from(request.getExpirationDate()), insertOperator: "memberKey", referenceKey: "101")
