...
class ReviewRewardMapperSpec extends Specification {
  ...
  def "ReviewRewardRequestDto -> ReviewReward 매핑 확인"() {
    ...
    "렌터카 프리미엄 상품평" | ReviewRewardRequestDto_생성(referenceType: ReviewReferenceType.RentalCar) | EventType.ReviewPremium | ReviewReward_생성(saveAmount: 10, eventType: EventType.ReviewPremium, referenceType: ReviewReferenceType.RentalCar)
  }
}
