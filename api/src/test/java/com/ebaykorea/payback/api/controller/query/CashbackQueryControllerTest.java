...
import com.ebaykorea.payback.api.ApiApplication;
...
class CashbackQueryControllerTest {
    ...
    void getCashbackReward() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = post("/api/Read/V2/CashbackReward")
    ...
    void getCashbackRewardOrder() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = post("/api/Read/V2/CashbackReward/order")
                .contentType(MediaType.APPLICATION_JSON)
                .content(requestJson)
                .accept(MediaType.APPLICATION_JSON);
