...
public interface CashEventRewardMapper {
  ...
  CashEventRewardReqest map(ReviewRewardRequestDto requestDto, EventType eventType);
  ...
  CashEventRewardReqest map(MemberEventRewardRequestDto requestDto, String memberKey);
}
