...
@AllArgsConstructor
@NoArgsConstructor
public class UpdateSsgPointTradeStatusRequestDto implements SsgPointRequestable {
  ...
  public SsgPointRequestKey key(long orderNo) {
    return new SsgPointRequestKey(orderNo, buyerId, siteType, PointTradeType.from(tradeType));
  }
}
