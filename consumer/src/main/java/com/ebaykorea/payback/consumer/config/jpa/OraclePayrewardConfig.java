...
import com.ebaykorea.payback.consumer.config.jpa.hibernate.HibernateAdapterFactory;
...
public class OraclePayrewardConfig extends HibernateAdapterFactory {
  ...
  public final static String ENTITY_PACKAGE_NAME = "com.ebaykorea.payback.consumer.repository.opayreward.entity";
  public final static String REPOSITORY_PACKAGE_NAME = "com.ebaykorea.payback.consumer.repository.opayreward";
