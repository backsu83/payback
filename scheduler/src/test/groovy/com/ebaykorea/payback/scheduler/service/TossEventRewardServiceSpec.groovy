...
class TossEventRewardServiceSpec extends Specification {
  ...
  def service = new TossEventRewardService(eventRewardRepositoryCustom, statusRepository, quiltApi, paybackApiClient)
  ...
  def "eventReward 미처리건에 대한 대응 확인"() {
    ...
    paybackApiClient.retryTossEventReward(_ as TossEventRewardRequestDto) >> Optional.ofNullable(CommonResponse_생성())
